...
export default function ManageTeachers() {
  ...
  const createMutation = useMutation({
    mutationFn: () =>
      api.post('/users', { fullName, email, password, role: 'teacher' }),
    onSuccess: () => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.introCard}>
        <Text style={styles.introTitle}>Teacher Accounts</Text>
        <Text style={styles.introSub}>Add teachers and manage their access.</Text>
      </View>
      ...
      <FlatList
        ...
        contentContainerStyle={[
          styles.listContent,
          teachers?.length === 0 ? styles.center : undefined,
        ]}
